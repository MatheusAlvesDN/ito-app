  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-950 relative h-full overflow-hidden text-slate-100">
      ...
      <div className="p-4 flex items-center bg-slate-900/60 border-b border-white/5 backdrop-blur-md sticky top-0 z-20 pt-8 md:pt-4 safe-top shrink-0">
        <button onClick={onBack} aria-label="Voltar" className="p-2 bg-white/5 rounded-full hover:bg-white/10 text-slate-200 transition-colors">
          <ChevronLeft size={24} />
        </button>
      ...
      <div className="flex-1 p-6 flex flex-col justify-center max-w-sm mx-auto w-full overflow-y-auto pb-12 gap-5">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="playerNameInput" className="block text-[11px] font-black uppercase tracking-wider text-slate-400 mb-1.5 font-outfit">Seu Nome / Apelido</label>
            <input
              id="playerNameInput"
              type="text"
          ...
          <div className="bg-slate-900/30 p-4 rounded-3xl border border-white/5 space-y-3 mt-2">
            <div>
              <label htmlFor="roomCodeInput" className="block text-[10px] font-black uppercase tracking-wider text-slate-450 mb-1.5 font-outfit">Código da Sala</label>
              <input
                id="roomCodeInput"
                type="text"
                placeholder="Ex: ABCD"
