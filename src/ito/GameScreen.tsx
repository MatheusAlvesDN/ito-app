...
// BOLT OPTIMIZATION: Wrapping SortablePlayerItem in React.memo prevents expensive re-renders
// of the entire list of players during drag-and-drop interactions, significantly improving performance.
