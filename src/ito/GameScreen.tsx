...
// BOLT OPTIMIZATION: Wrapping draggable list item with React.memo
// This prevents the entire list from re-rendering during expensive drag-and-drop interactions.
