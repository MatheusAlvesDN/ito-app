...
// ⚡ BOLT OPTIMIZATION: Wrapped in React.memo to prevent expensive re-renders of the entire list
// during drag-and-drop interactions. Only items that change their props will re-render.
