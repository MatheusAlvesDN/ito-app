...
const Confetti = memo(() => {
  // BOLT OPTIMIZATION: Encapsulate random particle generation in lazy useState to prevent recalculation on every re-render and avoid react-hooks/purity errors.
