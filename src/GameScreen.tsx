...
const Confetti = () => {
  // ⚡ Bolt: Use a lazy initializer function for useState to generate particles once on mount,
  // avoiding both the React purity lint error (Math.random during render) and unnecessary recreation of the array.
