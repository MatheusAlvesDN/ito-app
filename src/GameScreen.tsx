...
const Confetti = () => {
  // ⚡ Bolt: Use lazy initialization to compute particles only once per component mount.
  // This prevents ~250 unnecessary Math.random() calls on every re-render and ensures
  // the animation doesn't jitter or reset unexpectedly if the parent re-renders.
