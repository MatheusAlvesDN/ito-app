...
const Confetti = () => {
  // Cria 50 partículas com posições e cores aleatórias no mount
  // ⚡ Bolt: Moved Math.random() into useState lazy initializer to prevent re-renders
  // from recalculating properties, avoiding React purity violations.
