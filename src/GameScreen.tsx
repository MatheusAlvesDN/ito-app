...
const Confetti = () => {
  // Usa useState com lazy initialization para calcular as posições aleatórias
  // apenas uma vez durante a montagem do componente, evitando recálculos e
  // erros de 'impure function during render' em cada re-render.
