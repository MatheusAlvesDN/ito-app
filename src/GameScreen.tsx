...
const Confetti = () => {
  ...
  // ⚡ Bolt: Mover geração randômica para lazy initialization com useState previne
  // recálculos desnecessários e função impura durante o render (React purity rules)
