...
const Confetti = () => {
  // ⚡ Bolt: Lazy initialize Confetti particles to avoid recalculating random properties and array allocation on every re-render
  // This resolves the "Cannot call impure function during render" linter error and saves 50 object allocations per render
