...
const Confetti = () => {
  // Cria 50 partículas com posições e cores aleatórias - usando inicializador lazy do useState
  // para manter a pureza do render e evitar a recriação das partículas a cada re-render.
