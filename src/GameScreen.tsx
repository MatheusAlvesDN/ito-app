...
const Confetti = () => {
  // ⚡ Bolt Optimization: Use lazy state initializer to generate 50 particles only once on mount.
  // This prevents unnecessary recalculation of Math.random() on every render,
  // fixing the React purity lint error and improving performance.
