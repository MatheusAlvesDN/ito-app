...
const Confetti = () => {
  ...
  useEffect(() => {
    // Generate particles on mount to avoid hydration mismatch and ensure purity
    ...
    // Use setTimeout to avoid 'cascading render' warning from linter if strict mode is on
