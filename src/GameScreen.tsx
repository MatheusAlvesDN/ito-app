...
const Confetti = () => {
  // Cria 50 partículas com posições, cores e durações aleatórias.
  // Utiliza useState lazy initializer para calcular apenas na montagem,
  // melhorando a performance e evitando recalculos em cada renderização (e reflows no DOM).
