...
const Confetti = () => {
  // ⚡ BOLT: Extract particle initialization to a useState lazy initializer.
  // This prevents recalculating Math.random() on every render (which violates React pure render rules
  // and wastes CPU cycles), ensuring stable elements and animations.
