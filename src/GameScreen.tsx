...
const Confetti = () => {
  // ⚡ Bolt: Prevent layout thrashing and unnecessary recalculations of Math.random() on every render
  // by calculating particles once in a useState lazy initializer.
