...
const Confetti = () => {
  // Cria 50 partículas com posições e cores aleatórias, mas dentro de um useState
  // para evitar re-renderizações com valores diferentes e manter pureza do React.
