...
const Confetti = () => {
  // Cria 50 partículas com posições, cores e durações de animação aleatórias
  // Otimização de performance: usa useState lazy initializer p/ evitar recálculo
  // e satisfazer as regras de pureza do React (Math.random).
