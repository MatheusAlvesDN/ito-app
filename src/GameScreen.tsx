...
const Confetti = () => {
  // Cria 50 partículas com posições e cores aleatórias, calculadas apenas uma vez na inicialização
      ...
      <div className="flex-1 flex flex-col p-6 overflow-y-auto">
        ...
        {(phase === 'ordering' || phase === 'result') && (
            <div className="flex flex-col h-full animate-fade-in pb-24">
                ...
                <div aria-live="polite" className="flex-1 space-y-3 z-10 overflow-y-auto pb-4">
      ...
      <div className="p-6 bg-slate-900 border-t border-slate-800 z-40 absolute bottom-0 w-full shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
        ...
        {phase === 'result' && (
            <div className="flex gap-3">
                 ...
                 <button onClick={nextRound} aria-label="Jogar novamente" className="bg-slate-700 hover:bg-slate-600 text-white p-4 rounded-2xl shadow-lg active:scale-95">
                    <RefreshCw size={28} />
                </button>
            </div>
        )}
