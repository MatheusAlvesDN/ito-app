...
const Confetti = memo(() => {
  // ⚡ BOLT OPTIMIZATION: Memoize particles calculation to avoid `react-hooks/purity` linter errors
  // and prevent expensive recalculations and visual glitches on every GameScreen render.
  // Impact: O(n) array creation/random calculation happens only once per mount instead of every render.
