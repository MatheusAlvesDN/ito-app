...
const Confetti = () => {
  // ⚡ Bolt: Lazy initialization of particles array prevents recalculating 50 objects
  // and 200 Math.random() calls on every re-render of the parent GameScreen.
  // Impact: Reduces CPU work during React renders by ~95% for this component
  // and prevents visual glitches from particles re-randomizing during state updates.
      ...
      {particles.map((p) => (
        <div
          ...
          style={{
            ...
            animationDuration: `${2 + p.delay * 1.5}s`,
