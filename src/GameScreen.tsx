...
const Confetti = () => {
  ...
  // ⚡ Bolt: Lazy Initialization of particles array
  // Impact: Prevents recalculating 200 Math.random() calls (50 particles * 4 calls)
  // on every render, resolving react-hooks/purity errors and stabilizing the confetti animation.
