  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - The window.screen.orientation API types are incomplete in standard DOM environments
        if (window.screen && window.screen.orientation && typeof window.screen.orientation.lock === 'function') {
          // @ts-expect-error - The window.screen.orientation.lock method types are missing in standard DOM environments
