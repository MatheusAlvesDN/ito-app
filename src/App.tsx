...
const HomeScreen = ({ onPlay }: { onPlay: () => void }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-sky-400 to-sky-200 relative overflow-hidden">
      <div className="absolute top-12 left-[-40px] opacity-80 animate-pulse"><Cloud size={120} className="text-white fill-white drop-shadow-sm" aria-hidden="true" /></div>
      <div className="absolute top-24 right-[-20px] opacity-60"><Cloud size={100} className="text-white fill-white drop-shadow-sm" aria-hidden="true" /></div>
      <div className="absolute bottom-32 left-8 opacity-40"><Cloud size={64} className="text-white fill-white" aria-hidden="true" /></div>
