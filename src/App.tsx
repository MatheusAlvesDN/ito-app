  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - The screen.orientation.lock API is not fully typed in standard browser DOM types
...
// Componente de Input Isolado para evitar re-renders na lista ao digitar
// ⚡ Bolt: Extract text input into isolated component to prevent parent/sibling re-renders on keystrokes
const PlayerInput = ({ onAddPlayer }: { onAddPlayer: (name: string) => void }) => {
