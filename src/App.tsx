  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - TS doesn't fully support Screen Orientation API types
...
// Isso evita re-renders da lista de jogadores e da tela inteira a cada caractere digitado
