...
// ⚡ Bolt: Isolated PlayerInput component to prevent parent re-renders.
// By keeping inputValue state local, RegisterScreen and its list won't re-render on every keystroke.
