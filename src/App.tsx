  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - The orientation lock API is not fully typed in all environments
...
// Componente isolado para input, evitando re-renders desnecessários na lista
// ⚡ Bolt: Extracting input state prevents the entire RegisterScreen and player list from re-rendering on every keystroke
