  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - Incomplete TypeScript definitions for window.screen.orientation.lock
...
// ⚡ Bolt: Extract high-frequency state update to prevent parent re-renders
