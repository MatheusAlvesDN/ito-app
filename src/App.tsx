  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - API might not be typed
...
// Componente isolado para o input de adicionar jogador,
// evitando que o RegisterScreen inteiro (e a lista de jogadores)
// re-renderize a cada caractere digitado (alta frequência).
