    ...
    const lockOrientation = async () => {
      try {
        ...
        if (window.screen && window.screen.orientation && typeof window.screen.orientation.lock === 'function') {
          // @ts-expect-error - window.screen.orientation.lock might not be typed in all environments
...
// Componente isolado para o input de jogador
// Otimização: Evita re-renderizar toda a lista de jogadores a cada tecla digitada
