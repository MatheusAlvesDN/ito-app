...
const RegisterScreen = ({ onBack, onNext }: { onBack: () => void, onNext: (players: string[]) => void }) => {
  ...
  const addPlayer = () => {
    // SECURE: Limit maximum players to 20 to prevent DoS in GameScreen random generation
        ...
        <div className="bg-white p-4 rounded-3xl shadow-lg mb-6 border border-slate-100 shrink-0">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder={localPlayers.length >= 20 ? "Limite de 20 jogadores atingido" : "Nome do participante"}
