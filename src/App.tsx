...
// Componente de Item da Lista de Jogadores (Memoizado para performance)
// Isso evita re-renderizar a lista inteira a cada caractere digitado no input
...
const RegisterScreen = ({ onBack, onNext }: { onBack: () => void, onNext: (players: string[]) => void }) => {
  ...
  // Função estável para remover jogador
