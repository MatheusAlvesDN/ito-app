  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - window.screen.orientation type definition might be incomplete in some environments
...
// Componente de Input Isolado para evitar re-renders na lista de jogadores ao digitar
