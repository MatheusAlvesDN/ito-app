...
const RegisterScreen = ({ onBack, onNext }: { onBack: () => void, onNext: (players: string[]) => void }) => {
  ...
  const addPlayer = () => {
    // SECURE: Limit the number of players to 20 to prevent a DoS vulnerability.
    // The random number assignment logic in GameScreen uses a do...while loop
    // bounded by 100 choices. More than 100 players would cause an infinite loop.
