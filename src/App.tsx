  ...
  useEffect(() => {
    const lockOrientation = async () => {
      try {
        ...
        // @ts-expect-error - Screen orientation API is not fully typed in standard DOM types
...
// ⚡ Bolt: Isolated Input Component to prevent re-rendering the entire RegisterScreen (and list of players) on every keystroke
